...
final DUMMY_PRODUTOS = [
  Produto(
    ...
    descricao: 'Uma camiseta vermelha - é bem vermelha!',
    preco: 29.99,
    imagemUrl:
  ...
  Produto(
    id: 'p2',
    nome: 'Calças',
    descricao: 'Um bom par de calças.',
    preco: 59.99,
    imagemUrl:
  ...
  Produto(
    id: 'p4',
    nome: 'Uma Panela',
    descricao: 'Prepare qualquer refeição que você quiser.',
    preco: 49.99,
    imagemUrl:
